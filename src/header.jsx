...
const Header = () => {
  return (
    <div className="Header">
      <h1><a href="#home">SHUBHAM JOSHI</a></h1>
      <ol>
        ...
        <li>
          ...
          HeaderContact.map((curr)=>{
            return(<li><a href={curr.link} target="_blank"><img src={curr.logo} alt="Logo" width="15px"/> {curr.text}</a></li>)
          })
          }
          </ul>
        </li>
          ...
          <ul className="DropDown">
            {
              HeaderProjects.map((curr)=>{
                return(<li><a href={curr.link} target="_blank">{curr.text}</a></li>)
              })
            }
            
          </ul>
        </li>
        <li><a href="https://drive.google.com/file/d/170t40CWF0c0pLFkfXWJmqu7MMjPYWeO6/view?usp=sharing" target="_blank">Resume</a></li>
      </ol>
    </div>
  );
};
